...
Nota: si no usa BPMN formal, el bloque «Flujo AS-IS → TO-BE» cumple el mismo rol narrativo.`,
    ...
    b(
      ...
      "Explicación en lenguaje claro: entregables, niveles 0–2, relación con cronograma A–F.",
      EV3_EDT_QUE_ES,
      "edt",
    ),
    b(
      ...
      "Los cuatro paquetes y fases del proyecto.",
      EV3_EDT_INTRO_ARBOL,
      "edt",
    ),
    b(
      ...
      "Subpaquetes 1.1–1.6 con entregables en palabras simples.",
      EV3_EDT_P1,
      "edt",
    ),
    b(
      ...
      "Subpaquetes 2.1–2.6: app vecino, backend, alertas, panel.",
      EV3_EDT_P2,
      "edt",
    ),
    b(
      ...
      "Subpaquetes 3.1–3.6: mapa, dashboard, brigadas, sala crisis.",
      EV3_EDT_P3,
      "edt",
    ),
    b(
      ...
      "Subpaquetes 4.1–4.6: datos, APIs, reportes, cierre Fase 2.",
      EV3_EDT_P4,
      "edt",
    ),
    b(
