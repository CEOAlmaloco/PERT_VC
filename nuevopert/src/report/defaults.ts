  ...
  return {
    ...
    edtRoot: {
      ...
      children: [
        {
          id: "p1",
          label: "Paquete 1 — Gestión y administración",
          kind: "entregable",
          children: [
            { id: "p1-1", label: "1.1 Inicio y planificación", kind: "paquete" },
            { id: "p1-2", label: "1.2 Gestión contractual y legal", kind: "paquete" },
            { id: "p1-3", label: "1.3 Gestión de calidad", kind: "paquete" },
            { id: "p1-4", label: "1.4 Gestión de riesgos", kind: "paquete" },
            { id: "p1-5", label: "1.5 Comunicaciones", kind: "paquete" },
            { id: "p1-6", label: "1.6 Capacitación y cambio", kind: "actividad" },
          ],
        },
        {
          id: "p2",
          label: "Paquete 2 — Módulo C",
          kind: "entregable",
          children: [
            { id: "p2-1", label: "2.1 Análisis y diseño C", kind: "paquete" },
            { id: "p2-2", label: "2.2 PWA / App ciudadana", kind: "paquete" },
            { id: "p2-3", label: "2.3 Backend reportes", kind: "paquete" },
            { id: "p2-4", label: "2.4 Motor de alertas", kind: "paquete" },
            { id: "p2-5", label: "2.5 Panel moderación", kind: "paquete" },
            { id: "p2-6", label: "2.6 Testing y despliegue C", kind: "actividad" },
          ],
        },
        {
          id: "p3",
          label: "Paquete 3 — Módulo A",
          kind: "entregable",
          children: [
            { id: "p3-1", label: "3.1 Análisis y diseño A", kind: "paquete" },
            { id: "p3-2", label: "3.2 Visor GIS y mapa", kind: "paquete" },
            { id: "p3-3", label: "3.3 Dashboard operativo", kind: "paquete" },
            { id: "p3-4", label: "3.4 App brigadas móvil", kind: "paquete" },
            { id: "p3-5", label: "3.5 Infra sala crisis", kind: "paquete" },
            { id: "p3-6", label: "3.6 Testing y despliegue A", kind: "actividad" },
          ],
        },
        {
          id: "p4",
          label: "Paquete 4 — Módulo B",
          kind: "entregable",
          children: [
            { id: "p4-1", label: "4.1 Análisis y diseño B", kind: "paquete" },
            { id: "p4-2", label: "4.2 Hub datos e histórico", kind: "paquete" },
            { id: "p4-3", label: "4.3 API integración", kind: "paquete" },
            { id: "p4-4", label: "4.4 Analítica y reportes", kind: "paquete" },
            { id: "p4-5", label: "4.5 Seguridad y cumplimiento", kind: "paquete" },
            { id: "p4-6", label: "4.6 Testing y despliegue B", kind: "actividad" },
          ],
        },
      ],
    },
